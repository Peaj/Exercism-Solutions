...
def value_of_card_or_ace(card, hand_card_one, hand_card_two):
    if card == 'A':
        return value_of_ace(hand_card_one, hand_card_two)
...
def value_of_ace(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    if 'A' in (card_one, card_two): # Exception to satisfy test case
        return 1
